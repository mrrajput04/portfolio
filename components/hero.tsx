	...
	return (
		<section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-6 pt-16 overflow-hidden">
			...
			<div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 py-8 relative z-10">
				...
				<div className={`flex flex-wrap justify-center gap-3 sm:gap-4 pt-4 stagger-animation ${isLoaded ? 'stagger-group visible' : ''}`}>
					<Button asChild size="sm" className="sm:text-base sm:h-10 animate-float" style={{ animationDelay: '0.1s' }} data-stagger="1">
						<Link href="#contact">Contact Me</Link>
					</Button>
					<Button variant="outline" asChild size="sm" className="sm:text-base sm:h-10 animate-float" style={{ animationDelay: '0.2s' }} data-stagger="2">
						<Link href="#projects">View Projects</Link>
					</Button>
					<Button variant="secondary" asChild size="sm" className="sm:text-base sm:h-10 animate-float" style={{ animationDelay: '0.3s' }} data-stagger="3">
						<a
